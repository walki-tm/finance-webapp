...
function calculateNextDueDate(startDate, frequency, currentDate = new Date(), repeatData = null) {
  ...
  if (frequency === 'MONTHLY' || frequency === 'REPEAT') {
...
export async function createPlannedTransaction(userId, data) {
  const { title, main, subId, subName, amount, note, payee, frequency, startDate, confirmationMode, groupId, appliedToBudget, loanId, repeatCount } = data
