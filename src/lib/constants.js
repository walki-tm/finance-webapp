import { Wallet, TrendingDown, CreditCard, PiggyBank, ArrowRightLeft } from 'lucide-react'
...
export const MAIN_CATS = [
  ...
  { key:'transfer', name:'TRASFERIMENTO', color:'#9CA3AF', icon: ArrowRightLeft, iconKey: 'fi-transfer' },
]
