...
import { BarChart3, TrendingUp, Settings as SettingsIcon, CalendarDays, CreditCard, Target } from 'lucide-react';
...
export const tabs = [
  ...
  { key: 'savings-goals', label: 'Obiettivi', component: SavingsGoals, icon: Target },
];
